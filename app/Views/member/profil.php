...
<div class="profil-wrapper">
  ...
  <?php if (!empty($success)): ?>
    <div class="profil-alert ok" id="flashAlert">
      <svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><polyline points="20 6 9 17 4 12" fill="none"/></svg>
      <?= esc($success) ?>
  ...
  <?php if (!empty($error)): ?>
    <div class="profil-alert err" id="flashAlert">
      <svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="10" fill="none"/><line x1="12" y1="8" x2="12" y2="12"/><line x1="12" y1="16" x2="12.01" y2="16"/></svg>
      <?= esc($error) ?>
      <button onclick="this.closest('.profil-alert').remove()">×</button>
    </div>
  <?php endif; ?>
  ...
  <div class="profil-section">
    <div class="profil-section-header">
      ...
      <p>Perbarui informasi profile</p>
    </div>

    <form action="<?= base_url('member/profil/update') ?>" method="POST" enctype="multipart/form-data">
      <?= csrf_field() ?>
      <input type="file" id="inputFoto" name="foto_profil" accept="image/jpg,image/jpeg,image/png" style="display:none">
      ...
      <div class="foto-area">
        ...
        <button type="button" class="tombol-ubah-foto" onclick="document.getElementById('inputFoto').click()">
          <svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round">
            <path d="M23 19a2 2 0 01-2 2H3a2 2 0 01-2-2V8a2 2 0 012-2h4l2-3h6l2 3h4a2 2 0 012 2z" fill="none"/>
            <circle cx="12" cy="13" r="4" fill="none"/>
          </svg>
          Ubah Foto
        </button>
        <p class="hint-foto">Unggah foto profil dalam format JPG/JPEG/PNG</p>
      ...
      <div class="form-grid">
        ...
        <div class="form-grup">
          <label class="form-label" for="first_name">Nama Depan <span class="wajib">*</span></label>
        ...
        <div class="form-grup">
          <label class="form-label">
            Email
            <span class="kunci">
              <svg width="10" height="10" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><rect x="3" y="11" width="18" height="11" rx="2" ry="2" fill="none"/><path d="M7 11V7a5 5 0 0110 0v4" fill="none"/></svg>
              Tidak dapat diubah
            </span>
          </label>
        ...
        <div class="form-grup">
          ...
          <input type="text" class="form-input readonly"
                 value="<?= esc(strtoupper($member['uid'] ?? '—')) ?>" readonly>
        </div>
      ...
      <div class="form-aksi">
        <button type="submit" class="tombol-simpan">
          <svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><path d="M19 21H5a2 2 0 01-2-2V5a2 2 0 012-2h11l5 5v11a2 2 0 01-2 2z" fill="none"/><polyline points="17 21 17 13 7 13 7 21" fill="none"/><polyline points="7 3 7 8 15 8" fill="none"/></svg>
          Simpan
        </button>
      </div>
    </form>
        ...
        <div class="form-grup">
          ...
          <div class="pw-wrap">
            ...
            <button type="button" class="pw-toggle" onclick="togglePw('password_lama', this)">
              <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8z" fill="none"/><circle cx="12" cy="12" r="3" fill="none"/></svg>
            </button>
          </div>
        ...
        <div class="form-grup">
          ...
          <div class="pw-wrap">
            <input type="password" id="password_baru" name="password_baru"
                   ...
                   autocomplete="new-password" oninput="cekKekuatan(this.value)">
        ...
        <div class="form-grup">
          ...
          <div class="pw-wrap">
            <input type="password" id="konfirmasi" name="konfirmasi"
                   ...
                   autocomplete="new-password" oninput="cekKonfirmasi()">
...
document.getElementById('inputFoto').addEventListener('change', function () {
  ...
  reader.onload = function (e) {
    ...
    if (!img) {
      ...
      img.id = 'previewImg'; img.className = 'foto-lingkaran';
      document.querySelector('.foto-area').insertBefore(img, document.querySelector('.foto-area').firstChild);
    }
...
function togglePw(id, btn) {
  ...
  btn.querySelector('svg').innerHTML = show
    ...
    : `<path d="M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8z" fill="none"/><circle cx="12" cy="12" r="3" fill="none"/>`;
}
...
function cekKekuatan(val) {
  ...
  isi.style.width = (s * 25) + '%'; isi.style.background = warna[s];
  teks.textContent = label[s]; teks.style.color = warna[s];
}
